$(document).ready(function() {
	...
	$('#btn-place-order').click((event) => {
		...
		$.ajax({
			...
			url: "http://localhost/internetProgramming/api/v1/orders/index.php",
			type: 'post',
			data: {name_of_food:name_of_food, number_of_units:number_of_units,unit_price:unit_price,order_status:order_status},
			headers: {'Authorization':'uLA0DDybMpXJBa2WIGgLaMfzmGwClEd9J7XVr5QJ82HCctyfmPo9J8vhX0dXJCMG'},
			success: (data) => {
	...
	$('#btn-check-order').click((event) => {
		...
		$.ajax({
			...
			url: "http://localhost/internetProgramming/api/v1/orders/index.php?order_id="+order_id,
			type: 'get',
	...
	$('#btn-retrieve-order').click((event) => {
		...
		$.ajax({
			...
			url: "http://localhost/internetProgramming/api/v1/orders/index.php?retrieve_orders",
			type: 'get',
			headers: {'Authorization':'uLA0DDybMpXJBa2WIGgLaMfzmGwClEd9J7XVr5QJ82HCctyfmPo9J8vhX0dXJCMG'},
			success: (data) => {
				// console.log('Data incoming: ')
